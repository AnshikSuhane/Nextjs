  ...
  export const featuredProjects: Project[] = [
    {
      ...
      longDescription: "This comprehensive e-commerce platform features user authentication, product catalog with filtering and search, shopping cart functionality, secure checkout with Stripe integration, order management, and an admin dashboard for inventory control.",
      image: RealState,
    ...
    {
      title: "Fruit Store",
      description: "A responsive online store for browsing and purchasing fresh fruits.",
      longDescription: "Fruit Store is a user-friendly e-commerce application that allows customers to explore a wide variety of fresh fruits, view product details, add items to their cart, and securely place orders. The platform is built with a responsive design and real-time data handling using Firebase.",
    ...
    },
    {
      ...
      longDescription: "This portfolio website showcases professional work with smooth animations and transitions. Features include project galleries, skill visualization, contact forms, and responsive design for all devices.",
